...
<head>
    ...
    <style>
        ...
        .card-data {
            padding: 20px;
            border-radius: 8px;
            box-shadow: 0 4px 8px rgba(0, 255, 225, 0.6);
...
<body>
    ...
    <div class="container">
        <div class="card-data">
            <h2 class="mb-4" style="color: black;"><b> ข้อมูลผู้ใช้งานระบบ</b></h2>
            <hr>
                        ...
                        if ($user_type != "Admin") {
                            echo "<tr>
                                ...
                                <td class='text-center'>
                                    <a href='admin_user_edit.php?user_id_edit=$user_id' class='btn btn-link'><img src='imgs/edit.png' width='40' alt='Edit'></a>
                                    <a href='admin_user.php?user_id_del=$user_id' class='btn btn-link' onclick='return confirm(\"คุณแน่ใจหรือไม่ว่าต้องการลบข้อมูลนี้?\")'><img src='imgs/del.png' width='35' alt='Delete'></a>
                                </td>
                            </tr>";
                        }
                    }
